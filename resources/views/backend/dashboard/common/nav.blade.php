<nav class="navbar header-navbar pcoded-header">
   <div class="navbar-wrapper">
        ...
        <div class="navbar-logo">
            ...
            <a href="index-1.htm">
                <img class="img-fluid" src="{{ PUBLIC_URL }}files/assets/images/logo.png" alt="Theme-Logo">
            </a>
                ...
                <li class="header-notification">
                    <div class="dropdown-primary dropdown">
                        ...
                        <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            ...
                            <li>
                                <div class="media">
                                    <img class="d-flex align-self-center img-radius" src="{{ PUBLIC_URL }}files/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                    <div class="media-body">
