                               ...
                               <div class="card-block">
                                    <div class="row m-b-25">
                                        <div class="col-auto p-r-0">
                                           <div class="u-img">
                                                <img src="{{ PUBLIC_URL }}files/assets/images/breadcrumb-bg.jpg" alt="user image" class="img-radius cover-img">
                                                <img src="{{ PUBLIC_URL }}files/assets/images/avatar-2.jpg" alt="user image" class="img-radius profile-img">
                                           </div>
                                        </div>
                                        <div class="col">
                                                       ...
                                                       <tbody>
                                                            <tr>
                                                                <td class="b-none">
                                                                    ...
                                                                    <img src="{{ PUBLIC_URL }}files/assets/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                        ...
                                        <div class="card-block">
                                           ...
                                           <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <h6 class="text-muted f-w-400"><a href="{{ PUBLIC_URL }}cdn-cgi/l/email-protection.htm" class="__cf_email__" data-cfemail="1379767d6a53747e727a7f3d707c7e">[email&#160;protected]</a></h6>
                                                </div>
                                                <div class="col-sm-6">
