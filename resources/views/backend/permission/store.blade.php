<div class="pcoded-inner-content f-container">
     <div class="main-body">
        <div class="page-wrapper">
            ...
            @endif
            @php
                $url = ($method == 'create') ? url('backend/permission/store') : url('backend/permission/update/'.$permission->id);
             @endphp
          <form method="post" action="{{ $url }}" class="form-horizontal box" >
             ...
             <div class="page-body">
                <div class="row">
                     ...
                     <div class="ibox">
                        <div class="ibox-title">
                           <div class="uk-flex uk-flex-middle uk-flex-space-between">
                              <div>
                                 <h5>Quản lý {{ $config['moduleName'] }}</h5>
                        ...
                        <div class="ibox-content table-border-style">
                           @include('backend/permission/include/general')
                   ...
                   <div class="col-lg-4">
                       @include('backend/permission/include/aside')
                   </div>
                </div>
               </div>
             </form>
