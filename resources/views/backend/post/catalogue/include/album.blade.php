<div class="ibox mb20 album">
   <div class="ibox-title">
      <div class="uk-flex uk-flex-middle uk-flex-space-between">
         ...
         <div class="uk-flex uk-flex-middle uk-flex-space-between">
            <div class="edit">
               <a href="" title="" class="upload-picture">Upload hình ảnh</a>
            </div>
         </div>
      </div>
   </div>
   @php
      $album = (null != old('album')) ? old('album') : '';
   @endphp
   <div class="ibox-content">
      <div class="row">
         <div class="col-lg-12">
            @if(!isset($album) || is_array($album) == false || count($album) == 0)
            ...
            @endif
            <div class="upload-list {{ (isset($album) && is_array($album) && count($album)) ? 'dp-block' : '' }}" style="padding:5px;">
